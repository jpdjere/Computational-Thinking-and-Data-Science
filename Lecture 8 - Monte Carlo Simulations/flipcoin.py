...
def clt():
    for sampleSize in sampleSizes:
        sampleMeans = []
        for t in range(20): #Caluclo 20 veces el AVG y STD en cada samplesize
            sample = flipCoin(sampleSize) #y lo meto en sampleMeans
            sampleMeans.append(getMeanAndStd(sample)[0]) #el indice 0 es para el mean
        print(sampleMeans)
        #Calculo promedio de promedios y STD de promedios
